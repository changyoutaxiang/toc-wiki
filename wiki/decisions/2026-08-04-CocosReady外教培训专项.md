---
type: decision
title: Cocos Ready 外教培训专项定调（30 天就绪闭环）
tags: [battle, cocos, 培训, cocos-ready, 新师30天, 主要矛盾, 外教战役]
related: [2026-05-13-Cocos战略押注路径B, 2026-05-29-设备标准锚定Cocos黄金, Cocos, 新师训战营, 2026-08-04-招聘与数据治理专项对齐, 2026-08-24-老师为准客户经营哲学]
created: 2026-08-30
updated: 2026-08-30
sources: ["外教战役/Meeting/轻纪要-Cocos Ready外教培训专项对齐-2026-08-04.md"]
review: 记录
date: 2026-08-04
decided_by: 会议（王东主讲）
status: 生效
...
# Cocos Ready 外教培训专项定调（30 天就绪闭环）

> 时点：截至 2026-08-04。本页从 轻纪要-Cocos Ready外教培训专项对齐（自动轻纪要，Sophia 发起的视频会议；主讲王东，参与王东、Sophia）提取。源为会议纪要轻量版，无已审标记，`review: 记录`；Cocos Ready 的具名 owner、量化标准与验收结果仍待补齐。
...
1. **主要矛盾重新定义**：当前外教培训的主要矛盾是「新教师 Cocos 操作熟练度不足」，而非笼统的教学质量提升。矛盾须同时满足「重要性」与「短期可有效干预」两项条件。
2. **近期优先目标**：让新教师在 30 天内达到 Cocos Ready，以可执行的最低标准、训练路径和验收机制支撑；「新教师 30 天内达成 Cocos Ready」为当前优先目标。
3. **启动 Cocos Ready 专项攻坚**：由指定负责人接手并输出结构化解决方案，覆盖目标定义、最低能力标准、训练路径、验收方式及资源支持；标准可先「丑但可用」，优先建立能批量执行的基础门槛，再迭代完善（当前无量化标准，不能提前宣称已形成闭环）。
4. **培训侧先承担教师就绪闭环**：不等待 Cocos 完全优化再做培训闭环；短期先用训练、流程和必要资源投入托住交付，长期推动上游降低认知负荷（模板聚类工作已启动但处于早期）。
5. **协同方式与责任边界**：培训团队「不内斗、不甩锅、主动负责」——先保障教师能使用系统，同时持续向上游反馈问题；培训侧责任 = 让教师达到可验证的操作就绪，产品与教研侧责任 = 降低系统复杂度，前者为后者提供可讨论的事实证据。
6. **战略判断**：教学质量不是被否定，而是被重新排序——先具备「会开车」的基础操作能力，才谈教学技巧等进阶能力。
...
1. Cocos Ready 专项攻坚的指定负责人尚未具名；最低能力标准、训练路径、验收方式与量化标准均未产出。
...
[在本地目录反查本页](../TutorOS%E6%9C%AC%E5%9C%B0%E7%9F%A5%E8%AF%86%E5%AF%BC%E8%88%AA.md#page-5fa7fe1c4a444e3f)（本地资料，钉钉／GitHub未提供）。归属仅用于导航，不改变本页审态与适用边界。
