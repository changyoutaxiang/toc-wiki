...
type: decision
title: Battle1 周会拍板：SIV 双前置指标与 CE 团队移交
tags: [battle, siv, 前置指标, plan-b, 经济激励, ce移交, 区域资源, 外教战役]
related: [2026-08-12-SIV流程优化拍板, 2026-08-13-SIV录制工具专项与双入口并行, 2026-08-04-SIV恢复专项与算法owner补位, 2026-07-13-CEO下半年外教战役指示-双主帅H2总纲, 招聘战役, CE组织治理]
created: 2026-08-30
updated: 2026-09-15
sources: ["外教战役/Meeting/2026-08-13_Battle1_Weekly_meeting纪要.md"]
review: 记录
date: 2026-08-13
decided_by: 会议（王东、Jovic 主讲）
status: 生效
supersedes: []
superseded_by: []
---
...
> 时点：截至 2026-08-13。本页从 2026-08-13 Battle1 Weekly meeting 纪要（周例会，19 人）提取。源为会议纪要，无已审标记，`review: 记录`。本场是例行周会，但含明确拍板项（SIV 前置指标、Plan B 触发线、经济激励授权、CE 移交）；教师节活动、Hawk Eye 规划等为流水/跨场内容，不重复建页。
...
1. **拍定两个前置「体温计」指标**（不以滞后的上线人数判断修复效果）：`SIV 提交率＝提交人数/进入流程总人数`、`SIV 通过率＝通过人数/提交人数`；需回溯过去 7 天并连续观察今、明日趋势。
2. **提交率骤降首要嫌疑锁定为移除上传入口、强制使用单一工具**（8/10 改动，Kathy 尝试 5 次才完成的体验证据）；上传入口已于 8/12 晚恢复，预期提交率今晚或明早回到约 70%–80%，**该判断是验证假设、非已取得结果**。
3. **Plan B 触发线拍定**：当 SIV 通过率持续处于 50% 或以下时，立即触发 Plan B；候选措施包括前置 SIV 准备、增加 Leads/处理能力、视频缩短至 30 秒，具体组合未明确。
4. **授权 Jane 直接设计并快速执行经济激励**（无需逐层汇报）；吴丽霞承接资金部分；「提交合格 SIV 奖励 5 节课」为会上示例，最终奖励规则、预算与有效期未明确。依据：反复开会人工救火成本已过高，SIV 是客户选师体验载体，投入是客户价值投资。
5. **SIV 审核口径「先守底线、再提质量」**：声音清楚、面部可见、无严重噪声和合规风险是底线；灯光、背景、构图等可改善项暂不作为高压淘汰条件。该口径保护开学季产能，不等于永久降低标准；需分级清单、样例库与校准后稳定性数据验证（当前审核者同一视频判断不一致、人工 QA 偏严）。
6. **Lucy 的 CE 团队本周起正式移交 TOC，由 KK 管理**；国内与海外统一到一套系统、标准和团队运行方式。
7. **区域资源倾斜沿用既有边界**（非新规则）：国内达成率明显低于海外时可优先支持国内；两区拉平后如需继续调整必须另行请示。

## 依据

- 113 名进入流程者作为当日分析入口；现场出现 45、50、77 等不同口径数据，分母与时间窗口未完全统一，须由 Tammy 离线核数交叉检查。
- 历史数据：8/3 全面实施时提交率约 65%、一度升至 83%；8/7–8 约 75%–80%；8/11–12 明显下滑。
- 王东战略判断：SIV 必须执行，但新流程初期不能同时追求理想成片质量并牺牲开学季产能；可管理的问题先放行、上线后通过导师体系帮助优化，严重噪声、内容听不清及合规风险不可接受。
...
1. 提交率是否回到约 70%–80% 待今、明日数据验证；若未恢复需继续寻找其他原因。
2. Plan B 的具体组合（前置 SIV 准备/增加 Leads 与处理能力/缩短至 30 秒）未确定。
3. 经济激励的奖励规则、预算上限、停止规则与增量效果验证未明确（目标指标、预算、停止规则齐全才可复用）。
