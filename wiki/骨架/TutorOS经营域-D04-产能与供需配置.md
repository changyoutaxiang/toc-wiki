...
meaning_domain: D04
knowledge_revision: "D04-2026-09-16.1"
...
最近更新：2026-09-16。两库逐句校对，并登记 2026-09-15 供给规则拍板与 8PM 屏蔽放开第一刀；没有确认今天实际缺口与放开效果。

## 1. 客户价值：做好以后，谁会得到什么

设想家长为孩子选好了一节课：系统显示可约的老师确实有资格、有时间，也没有被另一个预约占用。遇到原老师临时不能上课时，平台能及时说明可提供的选择；客户接受替换以后，代课老师仍需把课教好。[E1][E2][E4]
...
**建议先看清“看板上的余量”和“一线实际能用的老师”为什么对不上。** 9 月 8 日聊天记录过这类异常，涉及限制接课、展示、预约和代课等不同条件；具体数量和日期表述仍有待核之处，不能直接当作今天的缺口。[E4] 2026-09-15 周会已对 8PM 峰值缺口现场复核并拍板放开第一刀（见“已有边界”与资料 [E5]）；一周观察结果出来前，本页不预判其效果。
...
2. **缺口原因决定补法。** 招聘、训练、激活、调整安排和放缓承接新需求各有用途，不能用同一种动作回答所有短缺。
3. **某一处好转，要看其他承诺是否受损。** 为一个市场多安排老师，不能在另一市场留下看不见的失约；替补到场也不能抹去原约未兑现。[E1][E3]

2026-09-14 本域从“形成并经营供给”观察面中单独划出，把讨论从教师人数推进到具体课位。招聘、新师培养、匹配和收入因此能围绕同一段真实供给经历对话；这不是统一供给表已经建成的证明。

2026-09-15 按模板把年度、季度、假设与好奇写开。本次没有新增实际产能、缺口比例、规则放宽或修复完成的证据。

2026-09-16 两库逐句校对：修正第 1、5 节两处引注，统一“形成并经营供给”与“放缓承接新需求”表述，补齐 8 月 21 日“半自动运行”的引文定位；登记 2026-09-15 供给规则拍板与 8PM 屏蔽放开第一刀对季度矛盾和好奇一的推进（[E5]），观察结果出来前不预判效果。
...
同场提出先让新师营产出得到认可，再讨论上游画像与流程重构；“减少日常盯办”的愿景后有半自动运行、保留人工投诉和本地整改的限定。规则简化以看得见事实、能测试并落实为前提。这改变验证次序，不签发取消岗位、招聘权限或提前删除规则。（同源 L264–279、447–455、479–484、574–604。）
...
**目前想到哪了：** 已有聊天指向接课限制、展示和实际代课之间的差异，但缺少同一时段的完整记录，不能认定唯一原因。[E4] 2026-09-15 周会对 8PM 峰值做过现场复核：系统显示 430 人可用，其中 322 人被“新老师前 10 节课屏蔽”挡住（会议口述数字，待智能体复核）；第一刀已放开 TP CAP 新老师屏蔽、观察一周，结果出来前这只是线索，不是答案。[E5] 值得把一次寻找代课的全过程与老师名单、资格、开放时段、联系结果及客户选择逐一对照；也看正常找到人的相反案例。
...
- 放宽新老师接课或代课限制的讨论，不等于普遍豁免；不能只因老师主动开了时段，就跳过资格和客户保护。2026-09-15 已单独拍板供给规则交统筹智能体与 8PM 屏蔽放开第一刀（先放开 TP CAP 新老师前 10 节屏蔽、观察一周，HBT 暂不放），见[2026-09-15-供给规则交统筹智能体与8PM屏蔽放开第一刀](../decisions/2026-09-15-供给规则交统筹智能体与8PM屏蔽放开第一刀.md) （[A](https://alidocs.dingtalk.com/i/nodes/Amq4vjg890blMv6ksxdrkgAjJ3kdP0wQ) · [Leon](https://alidocs.dingtalk.com/i/nodes/l6Pm2Db8D4BlnzPOTLqgmpNa8xLq0Ee4)）。本条边界继续适用于其余未决限制。[E5]
...
- **[E5] 2026-09-15 Battle-1 周会拍板：** [2026-09-15-供给规则交统筹智能体与8PM屏蔽放开第一刀](../decisions/2026-09-15-供给规则交统筹智能体与8PM屏蔽放开第一刀.md) （[A](https://alidocs.dingtalk.com/i/nodes/Amq4vjg890blMv6ksxdrkgAjJ3kdP0wQ) · [Leon](https://alidocs.dingtalk.com/i/nodes/l6Pm2Db8D4BlnzPOTLqgmpNa8xLq0Ee4)）。供给规则整体交统筹智能体、两条不可逆原则、8PM 缺口现场复核与放开第一刀；Leon 认可限确认稿本身，本页只作状态衔接与线索登记，不预判一周观察结果。
