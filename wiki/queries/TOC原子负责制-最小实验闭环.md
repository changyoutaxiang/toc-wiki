...
> [!warning] 候选方法 · 未生效
> 本页编译自《TOC原子负责制_最小实验闭环_候选.md》（2026-07-22 提出，2026-08-14 增量，status: candidate）。页面级 review 标 **待审**：本方法是**候选方法**，供 Leon、COO 与 agent 召回和检验；**不是已向团队生效的新规则**，也不构成 KPI、人员评价或对外承诺。若要正式生效，应另走相应的业务裁决与发布 gate。
