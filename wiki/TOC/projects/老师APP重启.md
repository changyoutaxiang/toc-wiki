...
「老师 APP 重启」是「沟通阵地」基建下挂的两条子项目之一（与 [[WhatsApp建设]] 并列）。
...
- 项目：[[WhatsApp建设]]（沟通阵地另一子项目，高触达辅助阵地）
- 决策：[[Q2关键决策与判断]]（Teacher APP 开发资源路径、安全审批、接口权限和维护 owner 为待决策项等时点判断）
- 项目：[[沟通矩阵建设]]（本项目与 WhatsApp 建设的上级基建）
